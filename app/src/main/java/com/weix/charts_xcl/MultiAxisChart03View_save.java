...
public class MultiAxisChart03View_save extends DemoView {
...
//	private LinkedList<AreaData> mDataset = new LinkedList<AreaData>();
	...
	// Y多轴
//	private LineChart chartLn1 = new LineChart();
...
//	private Paint mPaintTooltips = new Paint(Paint.ANTI_ALIAS_FLAG);
	...
	public MultiAxisChart03View_save(Context context, LinkedList<String> mLabelsAxes, LinkedList<Double> dataSeries1, LinkedList<Double> dataSeries2, LinkedList<Double> dataSeries3) {
		super(context);
		// TODO Auto-generated constructor stub
		initView();
	}

	public MultiAxisChart03View_save(Context context, AttributeSet attrs){
        super(context, attrs);
        initView();
	 }

	 public MultiAxisChart03View_save(Context context, AttributeSet attrs, int defStyle) {
...
//		AreaData line2 = new AreaData("小小熊",dataSeries2, Color.RED, Color.YELLOW); //(int)Color.rgb(254, 170, 50)
		//设置线上每点对应标签的颜色
...
//		line2.getPlotLine().getPlotDot().setRingInnerColor(Color.RED);
		LineData line2 = new LineData("小熊",dataSeries2, Color.RED);
		line2.setDotStyle(XEnum.DotStyle.RING);
		...
		try{												 
				...
				//数据轴最大值
				chart.getDataAxis().setAxisMax(800);
