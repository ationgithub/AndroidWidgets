...
public class SearchTipsGroupView extends LinearLayout {
     ...
     * @param onItemClick
     */
    public void initViews(String items[], final weix.xjp.searchtips.wideght.OnItemClick onItemClick) {
        ...
        for (int i = 0; i < size; i++) {//
            ...
            itemView.setOnClickListener(new OnClickListener() {//给每个item设置点击事件
                ...
                public void onClick(View v) {
                    if (null != onItemClick) {
                        v.setBackground(getResources().getDrawable(R.drawable.searchtip_shape));
            ...
            if (length > screenWidth/2) {//当前行的长度大于屏幕宽度则换行
//            if (j > 3) {//当前行的长度3
                length = 0;
     ...
     * @param onItemClick
     */
    public void initViews(List<String> items, weix.xjp.searchtips.wideght.OnItemClick onItemClick) {
