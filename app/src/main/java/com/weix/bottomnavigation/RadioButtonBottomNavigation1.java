...
public class RadioButtonBottomNavigation1 extends AppCompatActivity {
    ...
    private void initView() {
        ...
        findViewById(R.id.sign_iv).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(RadioButtonBottomNavigation1.this, RelativeLayoutTextviewBottomNavigation.class));
            }
        });
    }
